      ...
      <main id="main-content">
        ...
        <section className="bg-bg px-6 pb-20 md:px-10 lg:px-14">
          <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-center gap-10 lg:grid-cols-2">
            <div className="relative aspect-square overflow-hidden rounded-2xl border border-white/10 bg-bg-card">
              <Image
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              {robotSpecs.map((spec) => (
                <div
                  key={spec.label}
                  className="rounded-2xl border border-white/10 bg-bg-card p-6 transition-colors hover:border-green/50"
                >
